...
function saveIssue(event) {
    let issueId = chance.guid(); // global unique id
...
// load all issues from local storage, generates the HTML output for the issues lists and attaches the output to the DOM
